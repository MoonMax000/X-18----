...
**Цель:** Пом��чь пользователю ориентироваться в рынке и находить интересный контент
...
### 2️⃣ Мой профиль `/profile-page`

**Цель:** Показать мою статистику, доходы и управление подписками
...
**Итого: 7 виджетов (4 приватных + 3 общих)**
