...
echo "Applying migrations 007 and 008 to AWS RDS..."

PGPASSWORD='kn8wHxZT3P4yVmQs' psql -h tyriantrade-db.c01iqwikc9ht.us-east-1.rds.amazonaws.com -U dbadmin -d tyriantrade << 'EOF'
