...
const HomePostDetail: FC = () => {
  ...
  const postFromState = location.state as LabPost | undefined;
  const post = useMemo(() => {
    if (postFromState) {
  ...
  return (
    <div className="flex w-full gap-8">
      <div className="flex-1 max-w-[720px]">
        ...
        <TestFeedPost post={post} />

        {/* Comments Section */}
        <div className="mt-6 rounded-3xl border border-[#181B22] bg-background p-6">
          <h2 className="mb-4 text-lg font-semibold text-white">Comments</h2>
          <div className="flex flex-col items-center justify-center py-8 text-center text-[#8E92A0]">
