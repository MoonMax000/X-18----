    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="inline-flex flex-wrap items-center justify-center gap-2 md:gap-3 p-1 rounded-[36px] border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
          {tabs
            .filter((tab) => tab.id !== "streaming" && tab.id !== "portfolios")
            .map((tab) => (
              <button
                key={tab.id}
        ...
        {false && (
          <div className="flex flex-col gap-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
              {/* My Revenue Card */}
              {DASHBOARD_WIDGET_VISIBILITY.myRevenue && (
              ...
              {/* Live Streaming Card */}
              {DASHBOARD_WIDGET_VISIBILITY.liveStreaming && (
              ...
              {/* AI Assistant Card */}
              {DASHBOARD_WIDGET_VISIBILITY.aiAssistant && (
              ...
              <div className="flex h-full flex-col gap-3 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] p-4 backdrop-blur-[50px]">
                <div className="flex justify-between items-center pb-2">
                  <h3 className="text-lg md:text-xl font-bold text-white flex-1">
                    My Withdraws & Purchases
                  </h3>
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex flex-wrap items-center gap-2 md:gap-3 min-w-0">
                    <button className="flex items-center gap-1.5 h-7 px-2.5 rounded-[32px] border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[58.33px] text-white text-xs md:text-sm font-bold">
                      Withdraws
                    </button>
                    <button className="flex items-center gap-1.5 h-7 px-2.5 rounded-[32px] bg-gradient-to-r from-primary to-[#482090] backdrop-blur-[58.33px] text-white text-xs md:text-sm font-bold">
                      Purchases
                    </button>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 max-h-56 overflow-y-auto pr-1">
                  <div className="grid grid-cols-[minmax(0,1.4fr)_64px_72px_72px] items-center gap-2 px-3 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.1em] text-webGray">
                    <span className="w-[9ch] whitespace-nowrap">Product</span>
                  ...
                  {[
                    ...
                    <div
                      key={idx}
                      className="grid grid-cols-[minmax(0,1.4fr)_64px_72px_72px] items-center gap-2 rounded-xl border border-[#181B22] bg-[rgba(14,18,23,0.6)] px-3 py-2 text-[11px] md:text-xs"
                    >
                      <div className="group relative pr-2 text-white text-[11px] md:text-xs leading-snug">
                        <span className="block w-[9ch] truncate" title={item.name}>
                          {item.name}
                        </span>
                        <span className="pointer-events-none absolute left-0 top-full z-20 mt-1 hidden min-w-[12ch] max-w-xs whitespace-nowrap rounded-xl bg-white/10 px-3 py-1.5 text-[11px] md:text-xs leading-snug text-white shadow-[0_10px_30px_rgba(8,10,15,0.35)] backdrop-blur-[12px] group-hover:block">
                          {item.name}
                        </span>
                      </div>
                      ...
                      <div className="text-right text-white/70 text-[11px] md:text-xs">
                        {item.date}
                      </div>
                      <div
                        className={`justify-self-end w-[72px] text-right text-[10px] md:text-xs font-semibold uppercase tracking-wide ${item.statusColor}`}
                      >
                        {item.status}
                      </div>
                    </div>
              ...
              {DASHBOARD_WIDGET_VISIBILITY.followingPortfolios && (
                <div className="flex h-full flex-col justify-between gap-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] p-4 backdrop-blur-[50px]">
                <div className="flex justify-between items-baseline pb-2">
                  <h3 className="text-lg md:text-xl font-bold text-white flex-1">
                    Following Portfolios
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-wrap items-center gap-6">
                <button className="inline-flex h-8 items-center justify-center gap-2 px-3 rounded-full border border-[#181B22] bg-[rgba(12,16,20,0.5)] shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] text-white text-xs md:text-sm font-bold transition-colors hover:bg-[rgba(12,16,20,0.7)]">
                  Reset
                </button>
                <button className="inline-flex h-8 items-center justify-center gap-2 px-3 rounded-full bg-gradient-to-r from-primary to-[#482090] text-white text-xs md:text-sm font-bold transition-opacity hover:opacity-90">
                  Save Changes
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 p-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button className="w-full md:w-auto inline-flex h-8 items-center justify-center gap-2 px-3 rounded-full border border-[#181B22] bg-[rgba(12,16,20,0.5)] shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] text-white text-center text-xs md:text-sm font-bold transition-colors hover:bg-[rgba(12,16,20,0.7)]">
                  Add
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 p-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button className="w-full md:w-auto inline-flex h-8 items-center justify-center gap-2 px-3 rounded-full border border-[#523A83] bg-gradient-to-r from-primary to-[#482090] shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] text-white text-center text-xs md:text-sm font-bold transition-opacity hover:opacity-90">
                  Deactivate
                </button>
              </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button className="w-full md:w-auto inline-flex h-8 items-center justify-center gap-2 px-3 rounded-full border border-[#3A2127] bg-[rgba(12,16,20,0.5)] shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] text-[#EF454A] text-center text-xs md:text-sm font-bold transition-colors hover:bg-[rgba(12,16,20,0.7)]">
                  Delete
                </button>
              </div>
            </div>
