...
export const socialPosts: SocialPost[] = [
  ...
  },
  {
    ...
    title: "Exclusive Trading Insights for My Followers",
    preview: "Special insights and market analysis available only to my followers - no payment required, just follow to access!",
    body: "This is exclusive content for my followers. I share these insights as a thank you for your support.\n\nIn this post, I break down my current market outlook, key levels I'm watching, and potential trade setups for the coming week. This content is free but exclusive to followers only.\n\nFollow me to access this and future followers-only posts without any payment required!",
    mediaUrl:
    ...
    sentiment: "bullish",
    category: "Followers Only",
    likes: 256,
    comments: 42,
    views: 3200,
    audience: "followers",
    unlocked: false,
    hashtags: ["Exclusive", "FollowersOnly", "FreeInsights"],
  },
  {
    id: "crypto-video",
    type: "video",
