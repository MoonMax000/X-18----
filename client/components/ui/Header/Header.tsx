  ...
  return (
    <header className="pb-1 pt-3 w-full px-3 sm:px-4 md:pl-[30px] md:pr-[24px] bg-background items-center gap-2 mb-6">
      ...
      <div className="hidden md:grid grid-cols-[1fr_auto_1fr] items-center gap-2">
        ...
        {/* Center: Logo (when not authenticated) or Dashboard button (when authenticated) */}
        <div className="flex items-center gap-4 justify-self-center">
          {!user ? (
            ...
            <Link
              to="/dashboard"
              className="inline-flex items-center justify-center px-5 py-2 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[#A06AFF] to-[#7C3AED] hover:from-[#B084FF] hover:to-[#8B49FF] transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Dashboard
            </Link>
          )}
        ...
        {/* Right actions - moved search here when authenticated */}
        {user && (
        <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 hidden xl:block" style={{ marginLeft: '150px' }}>
