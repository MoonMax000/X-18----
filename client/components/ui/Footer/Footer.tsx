            ...
            <ul className="mt-5 flex flex-wrap gap-2">
              <li>
                <a
                  ...
                  aria-label="Twitter"
                >
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative z-10 h-4 w-4 fill-white transition-all duration-300 group-hover:scale-110">
              ...
              <li>
                ...
                >
                  <Instagram className="relative z-10 h-4 w-4 text-white transition-all duration-300 group-hover:scale-110" />
                </a>
              </li>
              <li>
                <a
                  ...
                  aria-label="YouTube"
                >
                  <Youtube className="relative z-10 h-4 w-4 text-white transition-all duration-300 group-hover:scale-110" />
                </a>
              </li>
            </ul>
          </div>
