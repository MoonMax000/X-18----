            ...
            <ul className="mt-5 flex flex-wrap gap-2">
              <li>
                <a
                  ...
                  aria-label="Twitter"
                >
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative z-10 fill-white transition-all duration-300 group-hover:scale-110">
