...
const UnifiedPostDetail: FC<UnifiedPostDetailProps> = ({ post }) => {
  ...
  return (
    <article className="mx-auto flex w-full sm:max-w-[680px] flex-col gap-4 sm:gap-6 bg-black p-4 sm:p-6 text-white">
      ...
      {/* Comment Form */}
      <div className="rounded-2xl border border-[#5E5E5E] bg-[#0A0A0A] p-3 transition-all duration-300 hover:border-[#B87AFF] hover:shadow-[0_0_20px_rgba(184,122,255,0.25)]">
