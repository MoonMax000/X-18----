...
export const AvatarCropModal: FC<AvatarCropModalProps> = ({
  ...
  return createPortal(
    ...
    >
      <div
        ref={modalRef}
        className="relative w-full max-w-[600px] overflow-hidden rounded-3xl border border-[#181B22] bg-black shadow-[0_40px_120px_-40px_rgba(0,0,0,0.85)] backdrop-blur-[100px]"
      ...
      >
        ...
        <div className="p-6 space-y-6">
          {/* Cropper Container */}
          <div className="relative w-full h-[400px] rounded-2xl overflow-hidden border-2 border-[#1D9BF0] bg-black">
            <Cropper
              image={imageUrl}
              crop={crop}
              zoom={zoom}
          ...
          {/* Preview Sizes Info */}
          <div className="text-center text-xs text-[#808283]">
            Your avatar will be displayed at different sizes across the platform
          </div>
        </div>
