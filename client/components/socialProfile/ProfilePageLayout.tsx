  ...
  return (
    <div className="flex w-full gap-2 sm:gap-4 md:gap-8">
      ...
      <RightSidebar
        ...
        trendingTickers={sidebarTrendingTickers}
        selectedTicker={selectedTicker}
        onTickerClick={handleTickerClick}
        suggestedProfiles={sidebarSuggestedProfiles}
        newsItems={sidebarNewsItems}
        followRecommendations={sidebarFollowRecommendations}
        topAuthors={sidebarTopAuthors}
