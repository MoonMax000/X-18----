...
export default function ProfileContentClassic({
  ...
  useEffect(() => {
    const loadProfile = async () => {
      ...
      if (externalProfile && externalPosts) {
        ...
        // Convert User to SocialProfileData with fallback for avatar/cover
        const profileData: SocialProfileData = {
          ...
          avatar: externalProfile.avatar_url || getAvatarUrl(null),
          cover: externalProfile.header_url || getCoverUrl(null),
          location: '',
  ...
  return (
    ...
    >
      {/* Third Duplicate - Full UserHeader Style from /profile */}
      ...
      {/* Duplicate Avatar and Banner Section */}
