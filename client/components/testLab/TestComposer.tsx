...
const TestComposer: FC<TestComposerProps> = ({ userAvatar, userName, onSubmit }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-3xl border border-[#181B22] bg-background/90 p-5 shadow-[0_18px_40px_-24px_rgba(0,0,0,0.65)] backdrop-blur-[30px]">
        <div className="space-y-5">
          ...
          <div className="grid gap-3">
            ...
            <textarea
              ...
              rows={2}
              className="min-h-[56px] rounded-2xl border border-[#181B22] bg-[#0C101480] px-4 py-3 text-sm text-white placeholder:text-[#6C7280] focus:border-[#A06AFF] focus:outline-none"
