              ...
              >
                <div className="flex flex-1 items-start gap-2 sm:gap-2.5 md:gap-3">
                  ...
                  <div className="flex flex-1 flex-col min-w-0">
                    <div className="flex items-center gap-1 sm:gap-1.5 text-[15px] sm:text-base md:text-[15px] font-bold md:font-semibold leading-tight text-white hover:underline hover:underline-offset-2 transition-all">
            ...
            {isPaidLocked && (
              <section className="ml-[48px] sm:ml-[52px] md:ml-[56px] relative rounded-lg overflow-hidden min-h-[200px] sm:min-h-[240px] md:min-h-[280px] flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center gap-6 sm:gap-8 py-12 sm:py-16 px-4 sm:px-6">
                  ...
                  <button className="flex items-center justify-center rounded-full border border-[#525252] bg-gradient-to-r from-[#E6E6E6]/20 via-[#E6E6E6]/5 to-transparent px-8 sm:px-12 md:px-14 py-3 text-sm sm:text-[15px] font-medium text-[#E5E7EB] transition-all duration-300 hover:border-[#A06AFF] hover:from-[#A06AFF]/20 hover:via-[#A06AFF]/10 hover:to-transparent hover:shadow-lg hover:shadow-[#A06AFF]/30 focus:outline-none focus:ring-2 focus:ring-[#A06AFF] focus:ring-inset whitespace-nowrap">
                    Get Access
                  </button>
                </div>
              </section>
