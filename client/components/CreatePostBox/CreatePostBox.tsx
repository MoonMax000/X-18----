...
const CreatePostBox: FC<CreatePostBoxProps> = ({
  ...
  return (
    <div className="flex flex-col items-end gap-4 rounded-3xl border border-[rgba(40,44,52,1)] bg-black p-4 backdrop-blur-[50px]">
      {/* Input area */}
      <div className="flex w-full items-start gap-2">
        ...
        <div
          ...
          className="relative flex flex-1 flex-col items-center rounded-2xl border border-[rgba(40,44,52,1)] bg-black px-4 py-3 shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] cursor-pointer hover:bg-[#482090]/10 transition-colors"
        >
