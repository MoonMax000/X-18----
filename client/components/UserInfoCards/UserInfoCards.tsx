...
const UserInfoCards: FC = () => {
  return (
    <div className="flex w-full flex-col gap-3">
      <div className="flex items-center gap-2 rounded-2xl border border-[rgba(24,27,34,0.85)] bg-[rgba(12,16,20,0.55)] px-3 py-2.5 backdrop-blur-[50px] md:px-4 md:py-3">
      ...
      <div className="rounded-2xl border border-[rgba(24,27,34,0.85)] bg-[rgba(12,16,20,0.55)] px-3 py-3 backdrop-blur-[50px] md:px-4 md:py-4">
