...
const LoginModal: FC<LoginModalProps> = ({ isOpen, onClose, initialScreen = 'login' }) => {
  ...
  const handleTwitterLogin = async () => {
    try {
      ...
      alert('Twitter/X login integration coming soon!\n\nPlease use Email/Phone login for now.');
    } catch (error) {
      console.error('Twitter OAuth error:', error);
      setAuthError('Twitter login failed. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className="mt-auto flex flex-col items-center gap-6 pt-10">
              <div className="flex items-center justify-center gap-6">
                <button 
                  ...
                  disabled={isLoading}
                  className="flex items-center justify-center w-11 h-11 rounded-full border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px] hover:bg-[rgba(12,16,20,0.7)] hover:border-primary hover:shadow-lg hover:shadow-primary/30 hover:scale-110 active:scale-95 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button 
                  ...
                  disabled={isLoading}
                  className="flex items-center justify-center w-11 h-11 rounded-full border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px] hover:bg-[rgba(12,16,20,0.7)] hover:border-white hover:shadow-lg hover:shadow-white/30 hover:scale-110 active:scale-95 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
