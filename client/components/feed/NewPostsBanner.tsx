...
export default function NewPostsBanner({ count, onClick }: NewPostsBannerProps) {
  ...
  return (
    <div className="sticky top-0 z-40 flex justify-center py-2 animate-in fade-in slide-in-from-top-2 duration-300">
      <button
        onClick={onClick}
        className="group flex items-center gap-1 rounded-full bg-gradient-to-r from-[#A06AFF] to-[#482090] px-2 py-1 text-[10px] font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:scale-105"
      >
